    ...
    if ($transaction['status'] === 'lunas' || $transaction['status'] === 'success') {
                    ...
                    <select id="lomba"
                        ...
                        <?php foreach ($competitions as $competition): ?>
                            <option id="idLomba" value="<?php echo $competition['id']; ?>"
                                ...
                                data-deskripsi="<?php echo htmlspecialchars($competition['deskripsi']); ?>">
        ...
        <script>
            async function handleCompetitionChange(competitionId) {
                ...
                const participantDesk = select.options[select.selectedIndex].getAttribute('data-deskripsi');
                descriptionElement.textContent = participantDesk;
