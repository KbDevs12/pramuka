...
<body class="font-poppins antialiased">
    ...
    <section class="mt-20 max-w-5xl mx-auto px-4">
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 relative overflow-hidden">
            <!-- Decorative Elements -->
            <div class="absolute top-0 right-0 w-40 h-40 bg-blue-50 rounded-full -translate-y-1/2 translate-x-1/2">
            </div>
            <div class="absolute bottom-0 left-0 w-32 h-32 bg-yellow-50 rounded-full translate-y-1/2 -translate-x-1/2">
            </div>
            ...
            <div class="relative z-10">
                ...
                <form action="transaksi_status.php" method="get" class="max-w-md mx-auto">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg
